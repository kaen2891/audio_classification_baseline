...
from util.dataset import DepressedDataset
...
def collate_fn(batch):
    ...
    return input_features_padded, labels

def set_loader(args):
    train_dataset = DepressedDataset(train_flag='train', transform=None, args=args, print_flag=True)
    test_dataset = DepressedDataset(train_flag='test', transform=None, args=args, print_flag=True)
